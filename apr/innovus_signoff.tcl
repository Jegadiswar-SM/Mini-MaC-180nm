# =============================================================================
# innovus_signoff.tcl — Signoff Checks & Outputs  [SCL 180nm]
# =============================================================================
...
# 4. GDS Stream Out
# -----------------------------------------------------------------------
# Merge with SCL 180nm standard cell GDS
# set GDS_DIR "/path/to/scl180/gds"
# write_stream out/soc_top.gds \
#     -merge [list $GDS_DIR/sc9mc_cmos18g.gds] \
#     -units 1000 \
#     -mode ALL
...
puts "============================================"
puts "  SCL180 Innovus Signoff COMPLETE"
