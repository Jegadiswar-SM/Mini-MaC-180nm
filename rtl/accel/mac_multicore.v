...
module mac_multicore #(
    ...
    output wire        m_req_o_0,
    input  wire        m_gnt_i_0,
    output wire [31:0] m_addr_o_0,
    output wire        m_we_o_0,
    output wire [31:0] m_wdata_o_0,
    input  wire        m_rvalid_i_0,
    input  wire [31:0] m_rdata_i_0,

    output wire        m_req_o_1,
    input  wire        m_gnt_i_1,
    output wire [31:0] m_addr_o_1,
    output wire        m_we_o_1,
    output wire [31:0] m_wdata_o_1,
    input  wire        m_rvalid_i_1,
    input  wire [31:0] m_rdata_i_1,

    output wire        m_req_o_2,
    input  wire        m_gnt_i_2,
    output wire [31:0] m_addr_o_2,
    output wire        m_we_o_2,
    output wire [31:0] m_wdata_o_2,
    input  wire        m_rvalid_i_2,
    input  wire [31:0] m_rdata_i_2,

    output wire        m_req_o_3,
    input  wire        m_gnt_i_3,
    output wire [31:0] m_addr_o_3,
    output wire        m_we_o_3,
    output wire [31:0] m_wdata_o_3,
    input  wire        m_rvalid_i_3,
    input  wire [31:0] m_rdata_i_3,
